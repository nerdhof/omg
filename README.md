...
Here are some examples of music generated by OMG using open-source AI models:

<audio controls style="width: 100%; max-width: 600px;">
  <source src="samples/power-circus-hymn-02.mp3" type="audio/mpeg">
  Your browser does not support the audio element.
</audio>

**Power Circus Hymn** - An epic anthem for the 39C3 Power Circus performance

<audio controls style="width: 100%; max-width: 600px;">
  <source src="samples/power-circus-pirate.mp3" type="audio/mpeg">
  Your browser does not support the audio element.
</audio>

**Power Circus Pirate** - Adventurous pirate-themed music with circus flair

<audio controls style="width: 100%; max-width: 600px;">
  <source src="samples/demo-metal.mp3" type="audio/mpeg">
  Your browser does not support the audio element.
</audio>

**Demo Metal Track** - Heavy metal demonstration showcasing the model's versatility
